...
type _PaginatedTeamPermissions PaginatedTeamPermissions
...
func (o *PaginatedTeamPermissions) UnmarshalJSON(bytes []byte) (err error) {
	varPaginatedTeamPermissions := _PaginatedTeamPermissions{}

	if err = json.Unmarshal(bytes, &varPaginatedTeamPermissions); err == nil {
		*o = PaginatedTeamPermissions(varPaginatedTeamPermissions)
	}
