...
type _PaginatedIssueComments PaginatedIssueComments
...
func (o *PaginatedIssueComments) UnmarshalJSON(bytes []byte) (err error) {
	varPaginatedIssueComments := _PaginatedIssueComments{}

	if err = json.Unmarshal(bytes, &varPaginatedIssueComments); err == nil {
		*o = PaginatedIssueComments(varPaginatedIssueComments)
	}
