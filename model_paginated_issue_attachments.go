...
type _PaginatedIssueAttachments PaginatedIssueAttachments
...
func (o *PaginatedIssueAttachments) UnmarshalJSON(bytes []byte) (err error) {
	varPaginatedIssueAttachments := _PaginatedIssueAttachments{}

	if err = json.Unmarshal(bytes, &varPaginatedIssueAttachments); err == nil {
		*o = PaginatedIssueAttachments(varPaginatedIssueAttachments)
	}
