...
type _PaginatedTreeentries PaginatedTreeentries
...
func (o *PaginatedTreeentries) UnmarshalJSON(bytes []byte) (err error) {
	varPaginatedTreeentries := _PaginatedTreeentries{}

	if err = json.Unmarshal(bytes, &varPaginatedTreeentries); err == nil {
		*o = PaginatedTreeentries(varPaginatedTreeentries)
	}
