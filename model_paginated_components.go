...
type _PaginatedComponents PaginatedComponents
...
func (o *PaginatedComponents) UnmarshalJSON(bytes []byte) (err error) {
	varPaginatedComponents := _PaginatedComponents{}

	if err = json.Unmarshal(bytes, &varPaginatedComponents); err == nil {
		*o = PaginatedComponents(varPaginatedComponents)
	}
