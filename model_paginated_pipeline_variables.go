...
type _PaginatedPipelineVariables PaginatedPipelineVariables
...
func (o *PaginatedPipelineVariables) UnmarshalJSON(bytes []byte) (err error) {
	varPaginatedPipelineVariables := _PaginatedPipelineVariables{}

	if err = json.Unmarshal(bytes, &varPaginatedPipelineVariables); err == nil {
		*o = PaginatedPipelineVariables(varPaginatedPipelineVariables)
	}
