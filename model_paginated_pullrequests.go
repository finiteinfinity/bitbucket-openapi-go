...
type _PaginatedPullrequests PaginatedPullrequests
...
func (o *PaginatedPullrequests) UnmarshalJSON(bytes []byte) (err error) {
	varPaginatedPullrequests := _PaginatedPullrequests{}

	if err = json.Unmarshal(bytes, &varPaginatedPullrequests); err == nil {
		*o = PaginatedPullrequests(varPaginatedPullrequests)
	}
