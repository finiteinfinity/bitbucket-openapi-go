...
type _PaginatedEnvironments PaginatedEnvironments
...
func (o *PaginatedEnvironments) UnmarshalJSON(bytes []byte) (err error) {
	varPaginatedEnvironments := _PaginatedEnvironments{}

	if err = json.Unmarshal(bytes, &varPaginatedEnvironments); err == nil {
		*o = PaginatedEnvironments(varPaginatedEnvironments)
	}
