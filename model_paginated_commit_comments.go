...
type _PaginatedCommitComments PaginatedCommitComments
...
func (o *PaginatedCommitComments) UnmarshalJSON(bytes []byte) (err error) {
	varPaginatedCommitComments := _PaginatedCommitComments{}

	if err = json.Unmarshal(bytes, &varPaginatedCommitComments); err == nil {
		*o = PaginatedCommitComments(varPaginatedCommitComments)
	}
