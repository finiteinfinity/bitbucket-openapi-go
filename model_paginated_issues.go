...
type _PaginatedIssues PaginatedIssues
...
func (o *PaginatedIssues) UnmarshalJSON(bytes []byte) (err error) {
	varPaginatedIssues := _PaginatedIssues{}

	if err = json.Unmarshal(bytes, &varPaginatedIssues); err == nil {
		*o = PaginatedIssues(varPaginatedIssues)
	}
