...
type _PaginatedPipelineSteps PaginatedPipelineSteps
...
func (o *PaginatedPipelineSteps) UnmarshalJSON(bytes []byte) (err error) {
	varPaginatedPipelineSteps := _PaginatedPipelineSteps{}

	if err = json.Unmarshal(bytes, &varPaginatedPipelineSteps); err == nil {
		*o = PaginatedPipelineSteps(varPaginatedPipelineSteps)
	}
