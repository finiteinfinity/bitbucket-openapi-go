...
type _PaginatedDiffstats PaginatedDiffstats
...
func (o *PaginatedDiffstats) UnmarshalJSON(bytes []byte) (err error) {
	varPaginatedDiffstats := _PaginatedDiffstats{}

	if err = json.Unmarshal(bytes, &varPaginatedDiffstats); err == nil {
		*o = PaginatedDiffstats(varPaginatedDiffstats)
	}
