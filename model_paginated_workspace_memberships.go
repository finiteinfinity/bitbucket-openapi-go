...
type _PaginatedWorkspaceMemberships PaginatedWorkspaceMemberships
...
func (o *PaginatedWorkspaceMemberships) UnmarshalJSON(bytes []byte) (err error) {
	varPaginatedWorkspaceMemberships := _PaginatedWorkspaceMemberships{}

	if err = json.Unmarshal(bytes, &varPaginatedWorkspaceMemberships); err == nil {
		*o = PaginatedWorkspaceMemberships(varPaginatedWorkspaceMemberships)
	}
