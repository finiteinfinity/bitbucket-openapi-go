...
type _PaginatedWebhookSubscriptions PaginatedWebhookSubscriptions
...
func (o *PaginatedWebhookSubscriptions) UnmarshalJSON(bytes []byte) (err error) {
	varPaginatedWebhookSubscriptions := _PaginatedWebhookSubscriptions{}

	if err = json.Unmarshal(bytes, &varPaginatedWebhookSubscriptions); err == nil {
		*o = PaginatedWebhookSubscriptions(varPaginatedWebhookSubscriptions)
	}
