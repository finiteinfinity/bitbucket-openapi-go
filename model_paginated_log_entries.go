...
type _PaginatedLogEntries PaginatedLogEntries
...
func (o *PaginatedLogEntries) UnmarshalJSON(bytes []byte) (err error) {
	varPaginatedLogEntries := _PaginatedLogEntries{}

	if err = json.Unmarshal(bytes, &varPaginatedLogEntries); err == nil {
		*o = PaginatedLogEntries(varPaginatedLogEntries)
	}
