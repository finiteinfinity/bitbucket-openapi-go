...
type _PaginatedProjects PaginatedProjects
...
func (o *PaginatedProjects) UnmarshalJSON(bytes []byte) (err error) {
	varPaginatedProjects := _PaginatedProjects{}

	if err = json.Unmarshal(bytes, &varPaginatedProjects); err == nil {
		*o = PaginatedProjects(varPaginatedProjects)
	}
