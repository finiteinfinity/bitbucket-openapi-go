...
type _PaginatedSnippetComments PaginatedSnippetComments
...
func (o *PaginatedSnippetComments) UnmarshalJSON(bytes []byte) (err error) {
	varPaginatedSnippetComments := _PaginatedSnippetComments{}

	if err = json.Unmarshal(bytes, &varPaginatedSnippetComments); err == nil {
		*o = PaginatedSnippetComments(varPaginatedSnippetComments)
	}
