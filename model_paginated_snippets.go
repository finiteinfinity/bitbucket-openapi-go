...
type _PaginatedSnippets PaginatedSnippets
...
func (o *PaginatedSnippets) UnmarshalJSON(bytes []byte) (err error) {
	varPaginatedSnippets := _PaginatedSnippets{}

	if err = json.Unmarshal(bytes, &varPaginatedSnippets); err == nil {
		*o = PaginatedSnippets(varPaginatedSnippets)
	}
