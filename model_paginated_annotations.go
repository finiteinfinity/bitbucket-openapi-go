...
type _PaginatedAnnotations PaginatedAnnotations
...
func (o *PaginatedAnnotations) UnmarshalJSON(bytes []byte) (err error) {
	varPaginatedAnnotations := _PaginatedAnnotations{}

	if err = json.Unmarshal(bytes, &varPaginatedAnnotations); err == nil {
		*o = PaginatedAnnotations(varPaginatedAnnotations)
	}
