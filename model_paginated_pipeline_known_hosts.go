...
type _PaginatedPipelineKnownHosts PaginatedPipelineKnownHosts
...
func (o *PaginatedPipelineKnownHosts) UnmarshalJSON(bytes []byte) (err error) {
	varPaginatedPipelineKnownHosts := _PaginatedPipelineKnownHosts{}

	if err = json.Unmarshal(bytes, &varPaginatedPipelineKnownHosts); err == nil {
		*o = PaginatedPipelineKnownHosts(varPaginatedPipelineKnownHosts)
	}
