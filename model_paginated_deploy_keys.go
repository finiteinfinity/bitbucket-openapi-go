...
type _PaginatedDeployKeys PaginatedDeployKeys
...
func (o *PaginatedDeployKeys) UnmarshalJSON(bytes []byte) (err error) {
	varPaginatedDeployKeys := _PaginatedDeployKeys{}

	if err = json.Unmarshal(bytes, &varPaginatedDeployKeys); err == nil {
		*o = PaginatedDeployKeys(varPaginatedDeployKeys)
	}
