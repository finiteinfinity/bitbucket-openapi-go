...
type _PaginatedBranches PaginatedBranches
...
func (o *PaginatedBranches) UnmarshalJSON(bytes []byte) (err error) {
	varPaginatedBranches := _PaginatedBranches{}

	if err = json.Unmarshal(bytes, &varPaginatedBranches); err == nil {
		*o = PaginatedBranches(varPaginatedBranches)
	}
