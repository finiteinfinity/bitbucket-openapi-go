...
type _PaginatedDeploymentVariable PaginatedDeploymentVariable
...
func (o *PaginatedDeploymentVariable) UnmarshalJSON(bytes []byte) (err error) {
	varPaginatedDeploymentVariable := _PaginatedDeploymentVariable{}

	if err = json.Unmarshal(bytes, &varPaginatedDeploymentVariable); err == nil {
		*o = PaginatedDeploymentVariable(varPaginatedDeploymentVariable)
	}
