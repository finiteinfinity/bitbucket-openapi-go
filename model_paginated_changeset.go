...
type _PaginatedChangeset PaginatedChangeset
...
func (o *PaginatedChangeset) UnmarshalJSON(bytes []byte) (err error) {
	varPaginatedChangeset := _PaginatedChangeset{}

	if err = json.Unmarshal(bytes, &varPaginatedChangeset); err == nil {
		*o = PaginatedChangeset(varPaginatedChangeset)
	}
