...
type _PaginatedPipelines PaginatedPipelines
...
func (o *PaginatedPipelines) UnmarshalJSON(bytes []byte) (err error) {
	varPaginatedPipelines := _PaginatedPipelines{}

	if err = json.Unmarshal(bytes, &varPaginatedPipelines); err == nil {
		*o = PaginatedPipelines(varPaginatedPipelines)
	}
