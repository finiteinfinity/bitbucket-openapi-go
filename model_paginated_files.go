...
type _PaginatedFiles PaginatedFiles
...
func (o *PaginatedFiles) UnmarshalJSON(bytes []byte) (err error) {
	varPaginatedFiles := _PaginatedFiles{}

	if err = json.Unmarshal(bytes, &varPaginatedFiles); err == nil {
		*o = PaginatedFiles(varPaginatedFiles)
	}
