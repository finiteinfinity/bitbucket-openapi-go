...
func (o *Project) GetHasPubliclyVisibleRepos() bool {
	if o == nil || o.HasPubliclyVisibleRepos == nil {
		var ret bool
		return ret
	}
	return *o.HasPubliclyVisibleRepos
}

// GetHasPubliclyVisibleReposOk returns a tuple with the HasPubliclyVisibleRepos field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Project) GetHasPubliclyVisibleReposOk() (*bool, bool) {
	if o == nil || o.HasPubliclyVisibleRepos == nil {
		return nil, false
	}
	return o.HasPubliclyVisibleRepos, true
}
