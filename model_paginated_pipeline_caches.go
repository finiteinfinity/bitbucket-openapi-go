...
type _PaginatedPipelineCaches PaginatedPipelineCaches
...
func (o *PaginatedPipelineCaches) UnmarshalJSON(bytes []byte) (err error) {
	varPaginatedPipelineCaches := _PaginatedPipelineCaches{}

	if err = json.Unmarshal(bytes, &varPaginatedPipelineCaches); err == nil {
		*o = PaginatedPipelineCaches(varPaginatedPipelineCaches)
	}
