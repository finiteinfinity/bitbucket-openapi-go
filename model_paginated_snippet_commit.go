...
type _PaginatedSnippetCommit PaginatedSnippetCommit
...
func (o *PaginatedSnippetCommit) UnmarshalJSON(bytes []byte) (err error) {
	varPaginatedSnippetCommit := _PaginatedSnippetCommit{}

	if err = json.Unmarshal(bytes, &varPaginatedSnippetCommit); err == nil {
		*o = PaginatedSnippetCommit(varPaginatedSnippetCommit)
	}
