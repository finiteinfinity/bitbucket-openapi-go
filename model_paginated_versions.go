...
type _PaginatedVersions PaginatedVersions
...
func (o *PaginatedVersions) UnmarshalJSON(bytes []byte) (err error) {
	varPaginatedVersions := _PaginatedVersions{}

	if err = json.Unmarshal(bytes, &varPaginatedVersions); err == nil {
		*o = PaginatedVersions(varPaginatedVersions)
	}
