...
type _PaginatedReports PaginatedReports
...
func (o *PaginatedReports) UnmarshalJSON(bytes []byte) (err error) {
	varPaginatedReports := _PaginatedReports{}

	if err = json.Unmarshal(bytes, &varPaginatedReports); err == nil {
		*o = PaginatedReports(varPaginatedReports)
	}
