...
type _PaginatedPipelineScheduleExecutions PaginatedPipelineScheduleExecutions
...
func (o *PaginatedPipelineScheduleExecutions) UnmarshalJSON(bytes []byte) (err error) {
	varPaginatedPipelineScheduleExecutions := _PaginatedPipelineScheduleExecutions{}

	if err = json.Unmarshal(bytes, &varPaginatedPipelineScheduleExecutions); err == nil {
		*o = PaginatedPipelineScheduleExecutions(varPaginatedPipelineScheduleExecutions)
	}
