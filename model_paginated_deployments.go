...
type _PaginatedDeployments PaginatedDeployments
...
func (o *PaginatedDeployments) UnmarshalJSON(bytes []byte) (err error) {
	varPaginatedDeployments := _PaginatedDeployments{}

	if err = json.Unmarshal(bytes, &varPaginatedDeployments); err == nil {
		*o = PaginatedDeployments(varPaginatedDeployments)
	}
