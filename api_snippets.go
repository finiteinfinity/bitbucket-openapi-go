...
func (r SnippetsApiSnippetsGetRequest) Role(role string) SnippetsApiSnippetsGetRequest {
	r.role = &role
	return r
}

func (r SnippetsApiSnippetsGetRequest) Execute() (*PaginatedSnippets, *http.Response, error) {
...
*/
func (a *SnippetsApiService) SnippetsGet(ctx context.Context) SnippetsApiSnippetsGetRequest {
	return SnippetsApiSnippetsGetRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *SnippetsApiService) SnippetsGetExecute(r SnippetsApiSnippetsGetRequest) (*PaginatedSnippets, *http.Response, error) {
	var (
...
func (r SnippetsApiSnippetsPostRequest) Body(body Snippet) SnippetsApiSnippetsPostRequest {
	r.body = &body
	return r
}

func (r SnippetsApiSnippetsPostRequest) Execute() (*Snippet, *http.Response, error) {
...
*/
func (a *SnippetsApiService) SnippetsPost(ctx context.Context) SnippetsApiSnippetsPostRequest {
	return SnippetsApiSnippetsPostRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return Snippet
func (a *SnippetsApiService) SnippetsPostExecute(r SnippetsApiSnippetsPostRequest) (*Snippet, *http.Response, error) {
	var (
...
func (r SnippetsApiSnippetsWorkspaceEncodedIdCommentsCommentIdDeleteRequest) Execute() (*http.Response, error) {
...
func (a *SnippetsApiService) SnippetsWorkspaceEncodedIdCommentsCommentIdDeleteExecute(r SnippetsApiSnippetsWorkspaceEncodedIdCommentsCommentIdDeleteRequest) (*http.Response, error) {
	...
	localVarPath = strings.Replace(localVarPath, "{"+"encoded_id"+"}", url.PathEscape(parameterToString(r.encodedId, "")), -1)
...
func (r SnippetsApiSnippetsWorkspaceEncodedIdCommentsCommentIdGetRequest) Execute() (*SnippetComment, *http.Response, error) {
...
func (r SnippetsApiSnippetsWorkspaceEncodedIdCommentsCommentIdPutRequest) Execute() (*http.Response, error) {
...
func (r SnippetsApiSnippetsWorkspaceEncodedIdCommentsGetRequest) Execute() (*PaginatedSnippetComments, *http.Response, error) {
...
func (a *SnippetsApiService) SnippetsWorkspaceEncodedIdCommentsGetExecute(r SnippetsApiSnippetsWorkspaceEncodedIdCommentsGetRequest) (*PaginatedSnippetComments, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r SnippetsApiSnippetsWorkspaceEncodedIdCommentsPostRequest) Body(body Snippet) SnippetsApiSnippetsWorkspaceEncodedIdCommentsPostRequest {
	r.body = &body
	return r
}

func (r SnippetsApiSnippetsWorkspaceEncodedIdCommentsPostRequest) Execute() (*Snippet, *http.Response, error) {
...
func (r SnippetsApiSnippetsWorkspaceEncodedIdCommitsGetRequest) Execute() (*PaginatedSnippetCommit, *http.Response, error) {
...
func (a *SnippetsApiService) SnippetsWorkspaceEncodedIdCommitsGetExecute(r SnippetsApiSnippetsWorkspaceEncodedIdCommitsGetRequest) (*PaginatedSnippetCommit, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r SnippetsApiSnippetsWorkspaceEncodedIdCommitsRevisionGetRequest) Execute() (*SnippetCommit, *http.Response, error) {
...
func (r SnippetsApiSnippetsWorkspaceEncodedIdDeleteRequest) Execute() (*http.Response, error) {
...
func (r SnippetsApiSnippetsWorkspaceEncodedIdFilesPathGetRequest) Execute() (*http.Response, error) {
...
func (r SnippetsApiSnippetsWorkspaceEncodedIdGetRequest) Execute() (*Snippet, *http.Response, error) {
...
func (r SnippetsApiSnippetsWorkspaceEncodedIdNodeIdDeleteRequest) Execute() (*http.Response, error) {
...
func (r SnippetsApiSnippetsWorkspaceEncodedIdNodeIdFilesPathGetRequest) Execute() (*http.Response, error) {
...
func (r SnippetsApiSnippetsWorkspaceEncodedIdNodeIdGetRequest) Execute() (*Snippet, *http.Response, error) {
...
func (r SnippetsApiSnippetsWorkspaceEncodedIdNodeIdPutRequest) Execute() (*Snippet, *http.Response, error) {
...
func (r SnippetsApiSnippetsWorkspaceEncodedIdPutRequest) Execute() (*Snippet, *http.Response, error) {
...
func (r SnippetsApiSnippetsWorkspaceEncodedIdRevisionDiffGetRequest) Path(path string) SnippetsApiSnippetsWorkspaceEncodedIdRevisionDiffGetRequest {
	r.path = &path
	return r
}

func (r SnippetsApiSnippetsWorkspaceEncodedIdRevisionDiffGetRequest) Execute() (*http.Response, error) {
...
func (r SnippetsApiSnippetsWorkspaceEncodedIdRevisionPatchGetRequest) Execute() (*http.Response, error) {
...
func (r SnippetsApiSnippetsWorkspaceEncodedIdWatchDeleteRequest) Execute() (*PaginatedUsers, *http.Response, error) {
...
func (r SnippetsApiSnippetsWorkspaceEncodedIdWatchGetRequest) Execute() (*PaginatedUsers, *http.Response, error) {
...
func (r SnippetsApiSnippetsWorkspaceEncodedIdWatchPutRequest) Execute() (*PaginatedUsers, *http.Response, error) {
...
func (r SnippetsApiSnippetsWorkspaceEncodedIdWatchersGetRequest) Execute() (*PaginatedUsers, *http.Response, error) {
...
// Filter down the result based on the authenticated user&#39;s role (&#x60;owner&#x60;, &#x60;contributor&#x60;, or &#x60;member&#x60;).
func (r SnippetsApiSnippetsWorkspaceGetRequest) Role(role string) SnippetsApiSnippetsWorkspaceGetRequest {
	r.role = &role
	return r
}

func (r SnippetsApiSnippetsWorkspaceGetRequest) Execute() (*PaginatedSnippets, *http.Response, error) {
...
// Execute executes the request
//  @return PaginatedSnippets
func (a *SnippetsApiService) SnippetsWorkspaceGetExecute(r SnippetsApiSnippetsWorkspaceGetRequest) (*PaginatedSnippets, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
// The new snippet object.
func (r SnippetsApiSnippetsWorkspacePostRequest) Body(body Snippet) SnippetsApiSnippetsWorkspacePostRequest {
	r.body = &body
	return r
}

func (r SnippetsApiSnippetsWorkspacePostRequest) Execute() (*Snippet, *http.Response, error) {
